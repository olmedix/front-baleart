...
export default function Card({ typeSpace,name,municipality,photo,modalities,score,votes,id,comments,description,services,regNumber }) {
    ...
    const space = { typeSpace, name, municipality, photo, modalities, score, votes, id, comments,description,services,regNumber };
