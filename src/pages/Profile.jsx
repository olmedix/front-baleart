...
if (error) return <p>Error: {error}</p>;
    ...
    return(
      ...
      <div className="flex justify-between">
        ...
        <div className="w-3/5 bg-slate-500 text-left">

          <h4 className="font-semibold ml-5">Nom</h4>
          <p className="ml-5">user.data.nombre</p>

          <h4 className="font-semibold ml-5">Cognoms</h4>
          <p className="ml-5">user.data.apellido</p>

          <h4 className="font-semibold ml-5">Email</h4>
          <p className="ml-5">user.data.email</p>

          <h4 className="font-semibold ml-5">Telèfon</h4>
          <p className="ml-5">user.data.telefono</p>

        </div>
        
        <div className="flex items-center">
          <button className="content-end border-2 font-semibold border-stone-500 py-3 px-14" type="button">
